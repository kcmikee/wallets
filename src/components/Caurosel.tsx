...
// import Carousell, { CarouselItem } from "./Slide";
    ...
    <div className="bg-black h-[102vh] w-[100vw] ">
      <div className="pt-[70px] w-[80%] mx-auto">
        ...
        <div className="relative h-[374px] w-[80%] mx-auto flex items-center justify-center mt-20">
          ...
          <p className="text-center text-3xl w-[80%] text-[#999999] font-[Eksell]">
            The Wallets payroll is seamless, the cards & sub wallets allow us to
            be flexible with payments and imprest to people outside of the main
            founding team. Hands down the Wallets team is the most responsive
            and customer-centric team I have ever worked with. Similar to
            Amazon’s focus on the customer I see Wallets having that same
            outlook
          </p>
        </div>
        <div className="mt-0 w-[80%] mx-auto flex items-center gap-4 ">
          ...
          <div className="">
            <h4 className="text-base text-white font-[Eksell]">Uzoma Ayogu</h4>
            <p className="text-sm text-[#999999]">
              Co-founder, Releaf (YC S17)
            </p>
          </div>
        </div>
            ...
            {[1, 2, 3].map((dot) => (
              <div
                ...
                className={`h-3 w-3 rounded-full bg-gray-900 ${
                  dot === active && "bg-[#fffddd]"
                }  `}
              />
            ))}
          </div>
          <div className="flex items-center gap-5">
            <div className="h-[40px] w-[40px] flex items-center justify-center rounded-full bg-white cursor-pointer">
              <img src={arrowLeft} alt="arrow" />
            </div>
            <div className="h-[40px] w-[40px] flex items-center justify-center rounded-full bg-[#00C9B6] cursor-pointer">
